                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        <div class="">
                            ...
                            <div class="flex flex-wrap">
                                ...
                                <div class="mb-4">
                                    <a href="{{route('posts.category', $category)}}" class="relative text-gray-300 hover:bg-gray-700 hover:text-white rounded-lg text-sm font-bold px-3 py-2 my-2">{{$category->name}}
                                        @php
                        ...
                        <div class="">
                            ...
                            <div class="flex flex-wrap">
                                @foreach ($tags as $tag)
                                    <div class="mb-4">
                                        <a href="{{route('posts.tag', $tag)}}" class="relative text-gray-300 hover:bg-gray-700 hover:text-white rounded-lg text-sm font-bold px-3 py-2" style="margin-bottom: 50px">{{$tag->name}}
                                            @php
