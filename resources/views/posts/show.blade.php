    ...
    <div class="py-6">
        <div class="container">
            <div class="p-2">
                ...
                <div class="text-base sm:text-lg text-gray-700 dark:text-gray-200 my-8 break-words font-semibold text-justify">
                    {!!$post->extract!!}
                </div>
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div id="post-body" class="my-6 text-base sm:text-lg text-gray-700 dark:text-gray-200 break-words font-semibold text-justify">
                            {!! $post->body !!}
                        </div>
                    </div>
                    {{-- Related content --}}
